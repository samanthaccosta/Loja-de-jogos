...
import br.org.generation.shopgame.repository.ProdutosRepository;
...
public class ProdutosController {
	...
	@PostMapping
	public ResponseEntity<Produtos>postProdutos(@RequestBody Produtos produto){
		return ResponseEntity.status(HttpStatus.CREATED).body(produtosRepository.save(produto));
	}
	@PutMapping
	public ResponseEntity<Produtos>putProdutos(@RequestBody Produtos produto){
