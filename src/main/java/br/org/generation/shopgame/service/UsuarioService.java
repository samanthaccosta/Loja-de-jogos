package br.org.generation.shopgame.service;
...
import br.org.generation.shopgame.repository.UsuarioRepository;
	...
	public Optional<UsuarioLogin> loginUsuario(Optional<UsuarioLogin> usuarioLogin){
		...
		if (usuario.isPresent()) {
			if (encoder.matches(usuarioLogin.get().getSenha(),usuario.get().getSenha())) {
				String auth = usuarioLogin.get().getSenha()+ ":" + usuarioLogin.get().getSenha();
